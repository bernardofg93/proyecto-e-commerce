...
// 	$usuario = stripslashes($usuario);
	...
	if (empty($usuario) or empty($password) or empty($password2)) {
		...
		try {
			$conexion = new PDO('mysql:host=localhost;dbname=ecommerce', 'root', '');
	...
	if ($errores == '') {
		$statement = $conexion->prepare('INSERT INTO login_usuarios (id_usuario, usuario, pass) VALUES (null, :usuario, :pass)');
...
require '../view/registrateView.php';
?>